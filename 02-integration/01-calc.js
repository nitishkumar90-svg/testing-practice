...
try {
  ...
  if (result !== 81) throw new Error('Expected calc("multiply", 9, 9) to be 2. Received: ' + result);
  ...
  if (result !== 3) throw new Error('Expected calc("divide", 9, 3) to be 2. Received: ' + result);
  ...
  if (result !== -1) throw new Error('Expected calc("exponent", 9, 3) to be 2. Received: ' + result);
